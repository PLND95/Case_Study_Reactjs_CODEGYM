  ...
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://640de8291a18a5db8382e24c.mockapi.io/users"
      );
      dispatch({
...
export const getAvatars = () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://640de8291a18a5db8382e24c.mockapi.io/avatars"
      );
      dispatch({
...
export const getBooks = () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://640de8291a18a5db8382e24c.mockapi.io/books"
      );
      dispatch({
...
export const getBorrowAndReturn = () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://640de8291a18a5db8382e24c.mockapi.io/borrowandreturn"
      );
      ...
      res.data.map((item, index) => {
        ...
        if (
          ...
          axios
            .put(
              `https://640de8291a18a5db8382e24c.mockapi.io/borrowandreturn/${item.id}`,
              { ...item, status: "Expires" }
            )
            .catch((err1) => {
  ...
  return async (dispatch) => {
    try {
      const res = await axios.delete(
        `https://640de8291a18a5db8382e24c.mockapi.io/users/${id}`
      );
      dispatch(getUsers());
    } catch (err) {
...
export const deleteBook = (id) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(
        `https://640de8291a18a5db8382e24c.mockapi.io/books/${id}`
      );
      dispatch(getBooks());
    } catch (err) {
...
export const updateBorrowAndReturn = (id, item) => {
  return async (dispatch) => {
    try {
      const res = await axios.put(
        `https://640de8291a18a5db8382e24c.mockapi.io/borrowandreturn/${id}`,
        item
      );
      dispatch(getBorrowAndReturn());
    } catch (err) {
